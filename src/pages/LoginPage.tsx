...
import { ArrowLeft, Mail, Lock, Eye, EyeOff, Code2, LogIn } from 'lucide-react';

// Reuse the Button component from HomePage
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="flex flex-col justify-center py-12 px-4">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <Link to="/" className="flex items-center text-blue-600 hover:text-blue-500 mb-6">
